...
const EditVoucher = ({ close, fetchData, voucherData }) => {
        ...
        <section className="fixed inset-0 backdrop-blur-sm bg-opacity-60 bg-neutral-900 z-50 flex justify-center items-center p-4">
            <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center border-b p-4">
                    <h2 className="text-xl font-semibold">Chỉnh Sửa Voucher</h2>
                    <button
                        onClick={close}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="col-span-1">
                            ...
                            <input
                                ...
                                value={formData.used}
                                onChange={handleChange}
                                className="w-full p-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500 bg-gray-100"
                                readOnly
                            />
                        </div>
